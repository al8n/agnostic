...
mod _tokio {
  ...
  mod tests {
    ...
    use super::{AsyncInterval, AsyncIntervalExt, TokioInterval};
...
mod _async_io {
  ...
  mod tests {
    ...
    use super::{AsyncInterval, AsyncIntervalExt, AsyncIoInterval};
    use std::time::{Duration, Instant};
...
mod _wasm {
  ...
  mod tests {
    ...
    use super::{AsyncInterval, AsyncIntervalExt, WasmInterval};
    use std::time::{Duration, Instant};
